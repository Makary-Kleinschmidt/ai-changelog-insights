...
# Now import main
from src.main import generate_site  # noqa: E402
...
class TestFlow(unittest.TestCase):
    ...
    def test_generate_site_flow(
        self, mock_json_dump, mock_file_open, mock_global_summary, mock_check_update, mock_yield_repos
    ):
