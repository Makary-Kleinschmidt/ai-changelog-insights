...
def _call_gemini_single_model(client, model_name, prompt, system_instruction, temperature, max_tokens, response_schema):
...
def _call_gemini_with_fallback(prompt, system_instruction, temperature=0.2, max_tokens=None, response_schema=None):
    """
    ...
    for model_name in models:
        ...
        try:
            return _call_gemini_single_model(client, model_name, prompt, system_instruction, temperature, max_tokens, response_schema)
        ...
        "properties": {
            ...
            "try_it_out": {
                ...
                "properties": {
                    ...
                    "beginner": {"type": "OBJECT", "properties": {"label": {"type": "STRING"}, "code": {"type": "STRING"}}},
                    "intermediate": {"type": "OBJECT", "properties": {"label": {"type": "STRING"}, "code": {"type": "STRING"}}},
                    "advanced": {"type": "OBJECT", "properties": {"label": {"type": "STRING"}, "code": {"type": "STRING"}}}
                }
            }
        },
